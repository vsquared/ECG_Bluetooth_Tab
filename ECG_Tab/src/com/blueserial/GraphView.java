...
// Uses Arduino sketch 'ECG_Tab'
// For use with Samsung Galaxy Tab S2
...
public class GraphView extends View
{
	...
	public void plotProcedure(int data) {
		...
		if (counter == 0) { path.moveTo(0, availableHeight - (data + baseline));} else {
			path.lineTo( counter*spacing, availableHeight - (data + baseline));
		}
		counter++;
		// Force redraw
		invalidate();
